        ...
        <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
                ...
                <div className="px-3 py-1.5 w-72 border border-white/10 rounded-lg flex items-center gap-3">
                    ...
                    value={search}
                    className="focus:ring-0 bg-transparent flex-1 outline-none p-0 border-0 text-sm" 
                ...
                <thead>
                    <tr className="border-b border-white/10">
                        <TableHeader style={{ width: 48 }}>
                            <input type="checkbox" className="size-4 bg-black/15 rounded border border-white/10 cursor-pointer checked:bg-orange-400" name="" id="" />
                        </TableHeader>
